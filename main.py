...
# ===================== CONFIG =====================
WINDOW_TITLE_REGEX = r"(OHIF|Radiant|PACS|Viewer|Carestream|GE|Philips|Agfa|Sectra)"
CONF_THRESHOLD_SHOW = 0.25
CONF_THRESHOLD_HIDE = 0.25
IOU_THRESHOLD = 0.3
TARGET_FPS = 3
FONT_FAMILY = "Arial"
FONT_SIZE = 14
...
class ControlPanel(QWidget):
    def __init__(self, overlay: OverlayScreen):
        ...
        self.btn_exit.setGeometry(5, 5, 70, 30)
        self.btn_exit.clicked.connect(self.overlay.close_overlay)

        self.btn_hide = QPushButton("Hide", self)
        self.btn_hide.setGeometry(5, 35, 70, 30)
        self.btn_hide.clicked.connect(self._toggle_hidden)
    ...
    def _toggle_hidden(self):
        self.btn_hide.setText("Hide" if self.overlay.hidden else "Show")
    ...
    def _toggle_inference(self):
        self.overlay.toggle_inference()
        self.btn_start.setText("Pause" if self.overlay.infer_active else "Start")
